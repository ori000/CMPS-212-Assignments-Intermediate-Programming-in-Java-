...
//Kindly ignore this class as it is not used in this problem
...
/*public class HourlyEmployee extends Employee{
    ...
    @Override
    public double getPaymentAmount(){ return wage * hours;}


    public String toString(){

        return String.format("Hourly employee: %s\t%s\nSocial Security Number: %S\nHourly wage: %.1f\nhours worked: %.1f\nearned: $%.1f", getFN(),getLN(),getSSN(),getWage(),getHours(),earnings());
